...
A client-side React app for creating polished Bayfields hearing assessment reports. It includes manufacturer summaries for Starkey, Oticon Reveal, Widex, Rexton and Signia maX, plus a printable PDF-style report preview and a standalone HTML copy.
