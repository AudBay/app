...
const bayfieldsLogo = "/Bayfields_Logo_1782311735117.jpg";
...
interface FormState {
  title: string; clientName: string; clientId: string;
...
export default function App() {
  ...
  const valid = !!(form.clientName && form.testDate && form.audiologistName &&
  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      ...
      <div className="topbar no-print">
        ...
        <a
          href="./hearing-assessment-report.html"
          download="hearing-assessment-report.html"
          style={{
      ...
      {tab === "form" && (
        <div className="form-shell">
          ...
          <Card icon="👤" title="Client & Clinic Details">
            <div style={{ display: "grid", gridTemplateColumns: "120px 1fr", gap: 16 }}>
              <div>
                ...
                <Sel value={form.title} onChange={e => set("title", e.target.value)}>
                  {TITLES.map(t => <option key={t}>{t}</option>)}
                </Sel>
              </div>
              <div>
                <FieldLabel>Client Full Name *</FieldLabel>
                <Inp placeholder="e.g. Margaret Collins" value={form.clientName} onChange={e => set("clientName", e.target.value)} />
              </div>
              <div style={{ gridColumn: "1/-1", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                <div>
                  <FieldLabel>Client ID</FieldLabel>
                  <Inp placeholder="e.g. BAY-00123" value={form.clientId} onChange={e => set("clientId", e.target.value)} />
                </div>
                <div>
          ...
          <button className="gen-btn" disabled={!valid} onClick={() => { setDone(true); setTab("preview"); }}>
            Generate PDF Report →
          </button>
        </div>
      )}
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                ...
                <div style={{ flex: 1, textAlign: "center" }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "center", flexWrap: "wrap", gap: 20, color: "rgba(255,255,255,0.7)", fontSize: 9.5 }}>
                    <span><strong style={{ color: "white", letterSpacing: 0.3 }}>Client:</strong>&nbsp;{form.title} {form.clientName}</span>
                    ...
                    {form.clientId && <span><strong style={{ color: "white", letterSpacing: 0.3 }}>ID:</strong>&nbsp;{form.clientId}</span>}
                  </div>
                </div>
                <div style={{ width: 100 }} />
              </div>
